...
public class frmProduct extends javax.swing.JDialog {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        frmAddProduct dialog = new frmAddProduct(new javax.swing.JFrame(),true,dao,this);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        frmUpdateProduct dialog = new frmUpdateProduct(new javax.swing.JFrame(),true,dao,this,products.get(jTableProducts.getSelectedRow()));
        dialog.setVisible(true);
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        ...
        int result = JOptionPane.showConfirmDialog(this,"Are you sure ?" , "Remove the Current Product" ,JOptionPane.OK_CANCEL_OPTION,JOptionPane.QUESTION_MESSAGE );
        if(result == 0) {
            try{
                dao.removeProduct(products.get(jTableProducts.getSelectedRow()).getId());
            }catch(SQLException ex) {
                ex.printStackTrace();
                JOptionPane.showMessageDialog(this,"Error removig Product","Remove Product",JOptionPane.ERROR_MESSAGE);
            }
        }
        loadInitialData();
    ...
    public void loadInitialData() {
        try{
            ...
            jTableProducts.setModel(new MyTableModel(Product.class,products,jTableProducts));
        }catch(Exception e){
            e.printStackTrace();
        }
    }
