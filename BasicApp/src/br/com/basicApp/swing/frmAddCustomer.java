...
public class frmAddCustomer extends javax.swing.JDialog {
    ...
    public final frmCustomer frame;
    
    public frmAddCustomer(java.awt.Frame parent, boolean modal,CustomerDAO dao,frmCustomer frame) {
        super(parent, modal);
        this.frame = frame;
        this.dao = dao;
        initComponents();
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        int resp = JOptionPane.showConfirmDialog(this,"Are you sure ?","Add new Customer",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
        if(resp == 2) {
            return;
        }
        ...
        try{
            ...
            ctm.setTelephone(txtTelephone.getText());
            dao.addCustomer(ctm);
            frame.loadInitialData();
        }catch(Exception e){
            e.printStackTrace();
            JOptionPane.showMessageDialog(this,"Error adding new Customer , please try again !");
            return;
        }
        setVisible(false);
